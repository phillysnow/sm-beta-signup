...
function myInitCode() {
  var images = document.querySelector(".advantage-illustration");
  ...
  document.querySelectorAll(".advantage-wrap").forEach(function (el) {
  ...
  function onScroll(event) {
    ...
    document.querySelector("#myexample").style.setProperty("--y", "".concat(scrollY / 45, "%"));
  }
}
},{"./app.scss":"app.scss"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
